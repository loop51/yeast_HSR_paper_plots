...
plot_line_width = 2.5;
if ispc
    experiment_folder = "K:/measurement/fall2024/september12th";
    figure_save_folder = "K:\Yeast_Thermal_effect_paper\yeast HSR paper draft\Results\March2025_v2\yeast_sept12th\deltaS_vs_time";
elseif ismac
...
elseif isunix && ~ismac
    ...
    figure_save_folder = '/media/mdsaifi/Grace Lab/Yeast_Thermal_effect_paper/yeast HSR paper draft/Results/March2025_v2/yeast_sept12th/deltaS_vs_time';
end
if ~isfolder(figure_save_folder)
    mkdir(figure_save_folder);
end

data_32C_folder = "iteration1";
data_42C_folder = "iteration2";
...
%     % y_32C = y;
    time_points = [0 55 126 152 179 215];
