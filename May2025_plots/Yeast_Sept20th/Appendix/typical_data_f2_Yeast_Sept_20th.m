...
%%
if isunix && ~ismac
    figure_save_folder = '/media/mdsaifi/Grace Lab/Yeast_Thermal_effect_paper/yeast HSR paper draft/Results/March2025_v2/september20th/typical_data/f2';
elseif ispc
    figure_save_folder = 'K:\Yeast_Thermal_effect_paper\yeast HSR paper draft\Results\March2025_v2\september20th\typical_data\f2';
elseif ismac
...
elseif ispc
    data_path = 'Z:\September2024_Yeast_Measurements\September20th\Yeast SP at 32C\10.5GHz\set6';
elseif ismac
    % figure_save_folder = '/volumes/Grace Lab/Yeast_Thermal_effect_paper/Yeast_HSR_ADS_simualtions/ADS_Simulation_after_spring_break/figures';
end
