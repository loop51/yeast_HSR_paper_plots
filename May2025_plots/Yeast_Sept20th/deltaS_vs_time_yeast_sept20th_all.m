...
if ispc
    ...
    % figure_save_folder = "C:\Users\mdsaifi\Box\Research\Semesters\Fall2024\Yeast_Thermal_effect_paper\yeast HSR paper draft\Results\March2025\yeast_Sept20th\deltaS_vs_time";
    figure_save_folder = 'k:\Yeast_Thermal_effect_paper\yeast HSR paper draft\Results\March2025_v2\september20th\deltaS_vs_time_all\may';
elseif ismac
    experiment_folder = '/Volumes/Grace Lab/measurement/fall2024/september20th';
    figure_save_folder = '/Volumes/Grace Lab/Yeast_Thermal_effect_paper/yeast HSR paper draft/Results/March2025_v2/september20th/deltaS_vs_time_all/may'; 
elseif isunix && ~ismac
    experiment_folder = '/media/mdsaifi/Grace Lab/measurement/fall2024/september20th';
    figure_save_folder = '/media/mdsaifi/Grace Lab/Yeast_Thermal_effect_paper/yeast HSR paper draft/Results/March2025_v2/september20th/deltaS_vs_time_all/may';
end
...
%     % y_32C = y;
    ...
    current_figure.OuterPosition = [21.3229 0.4583 2.75 2.75];
