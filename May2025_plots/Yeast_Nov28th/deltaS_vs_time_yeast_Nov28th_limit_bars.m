...
plot_line_width = 2.5;
if ispc
    experiment_folder = "C:\Users\mdsaifi\Box\Measurement\Fall2024\November\28th Nov Yeast YPD\another_cell";
    % figure_save_folder = "C:\Users\mdsaifi\Box\Research\Semesters\Fall2024\Yeast_Thermal_effect_paper\yeast HSR paper draft\Results\March2025\yeast_Nov28th\deltaS_vs_time";
    figure_save_folder = "k:\Yeast_Thermal_effect_paper\yeast HSR paper draft\Results\March2025_v2\yeast_Nov28th\deltaS_vs_time";
elseif ismac
...
elseif isunix && ~ismac
    experiment_folder = '/media/mdsaifi/Grace Lab/measurement/fall2024/November/28th Nov Yeast YPD/another_cell';
    figure_save_folder = '/media/mdsaifi/Grace Lab/Yeast_Thermal_effect_paper/yeast HSR paper draft/Results/March2025_v2/yeast_Nov28th/deltaS_vs_time';
...
%     % y_32C = y;
    ...
    x =x_fit(x_fit<=for_transition_x);
   time_points = [1 8 15 24 100 200 300];
