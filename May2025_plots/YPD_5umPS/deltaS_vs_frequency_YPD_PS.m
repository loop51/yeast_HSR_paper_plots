...
assign_iteration_42C = [1, 1, 1, 1];
assign_set_42C = [5, 9, 15, 25];
...
for i=1:size(deltaS.s11m,1)
    hold on;
    if i<4
        plot(f, deltaS.s11m(i,:) - deltaS.s11m(1,:), '-o', 'Color', colors(i,:), 'LineWidth', plot_line_width);
    else
        plot(f, deltaS.s11m(i,:)-deltaS.s11m(1,:), '--o','Color', colors(i,:), 'LineWidth', plot_line_width);
    end
end
...
for i=1:size(deltaS.s11m,1)
    hold on;
    if i<4
        plot(f, deltaS.s11a(i,:)-deltaS.s11a(1,:), '-o', 'Color', colors(i,:), 'LineWidth', plot_line_width);
    else
        plot(f, deltaS.s11a(i,:)-deltaS.s11a(1,:), '--o','Color', colors(i,:),'LineWidth', plot_line_width);
    end
end
...
plot_s21a = gca;
%%
figure_dimension = 3.5/2;
figure_s11m.Units = 'inches';
figure_s11m.Position = [21.3229 0.4583 figure_dimension figure_dimension];
