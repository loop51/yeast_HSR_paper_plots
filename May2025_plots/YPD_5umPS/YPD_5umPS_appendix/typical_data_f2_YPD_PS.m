...
%%
if isunix && ~ismac
    figure_save_folder = '/media/mdsaifi/Grace Lab/Yeast_Thermal_effect_paper/yeast HSR paper draft/Results/March2025_v2/YPD_5um_PS/typical_data/f2';
elseif ispc
    figure_save_folder = 'K:\Yeast_Thermal_effect_paper\yeast HSR paper draft\Results\March2025_v2\YPD_5um_PS\typical_data\f2';
elseif ismac
...
elseif ispc
    data_path = 'C:\Users\mdsaifi\Box\Measurement\Fall2024\September19th\PS_5um_at_32C\iteration1\10.5GHz\set3';
elseif ismac
    % figure_save_folder = '/volumes/Grace Lab/Yeast_Thermal_effect_paper/Yeast_HSR_ADS_simualtions/ADS_Simulation_after_spring_break/figures';
end
...
current_figure = figure();
current_figure.Units = 'inches';
current_figure.Position = [.5  6.0625 8.27 3.5/2];
