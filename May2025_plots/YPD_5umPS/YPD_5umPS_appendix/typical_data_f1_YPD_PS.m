...
%%
if isunix && ~ismac
    figure_save_folder = '/media/mdsaifi/Grace Lab/Yeast_Thermal_effect_paper/yeast HSR paper draft/Results/March2025_v2/YPD_5um_PS/typical_data/f1';
elseif ispc
    figure_save_folder = 'K:\Yeast_Thermal_effect_paper\yeast HSR paper draft\Results\March2025_v2\YPD_5um_PS\typical_data\f1';
elseif ismac
...
elseif ispc
    data_path = 'C:\Users\mdsaifi\Box\Measurement\Fall2024\September19th\PS_5um_at_32C\iteration1\3.5GHz\set3';
elseif ismac
    % figure_save_folder = '/volumes/Grace Lab/Yeast_Thermal_effect_paper/Yeast_HSR_ADS_simualtions/ADS_Simulation_after_spring_break/figures';
end
...
current_figure.Position = [8 1.0625 3.5 3.5];
...
current_plot = gca;
current_figure.Units = 'inches';
current_figure.Position = [13.0104  1.0625 3.5 3.5];
% current_figure.OuterPosition = [21.3229 0.4583 3.5 3.5];
% current_plot.YRuler.Exponent = -2;
current_figure.MenuBar = 'none';
current_plot.FontSize = 8;
...
current_plot = gca;
current_figure.Units = 'inches';
current_figure.Position = [8 5.0625 3.5 3.5];
% current_figure.OuterPosition = [21.3229 0.4583 3.5 3.5];
% current_plot.YRuler.Exponent = -2;
current_figure.MenuBar = 'none';
current_plot.FontSize = 8;
...
current_plot = gca;
current_figure.Units = 'inches';
current_figure.Position = [13.0104  5.0625 3.5 3.5];
% current_figure.OuterPosition = [21.3229 0.4583 3.5 3.5];
% current_plot.YRuler.Exponent = -2;
current_figure.MenuBar = 'none';
current_plot.FontSize = 8;
...
current_figure = figure();
current_figure.Units = 'inches';
current_figure.Position = [0.25  6.0625 8.27 3.5/2];
