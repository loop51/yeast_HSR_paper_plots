...
exportgraphics(figure_s11m,strcat(figure_save_folder, filesep, 'reflection.pdf'), 'ContentType','vector');
exportgraphics(figure_s11m,strcat(figure_save_folder, filesep, 'reflection.png'), 'ContentType','vector');
% 
