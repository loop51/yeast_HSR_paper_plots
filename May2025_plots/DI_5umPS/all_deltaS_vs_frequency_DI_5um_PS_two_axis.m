...
if ispc
    ...
    figure_save_folder = "k:\Yeast_Thermal_effect_paper\yeast HSR paper draft\Results/March2025_v2\DI_Water_5um_PS\deltaS_vs_frequency";
elseif ismac
    experiment_folder = '/Users/ruzvaysaiful/Library/CloudStorage/Box-Box/Measurement/Fall2024/November/19th Nov PS 5um';
    figure_save_folder = '/Users/ruzvaysaiful/Library/CloudStorage/Box-Box/Research/Semesters/Fall2024/Yeast_Thermal_effect_paper/yeast HSR paper draft/Results/DI_Water_5um_PS/deltaS_vs_frequency';
elseif isunix && ~ismac
    experiment_folder = '/media/mdsaifi/Grace Lab/measurement/fall2024/November/19th Nov PS 5um';
    figure_save_folder = '/media/mdsaifi/Grace Lab/Yeast_Thermal_effect_paper/yeast HSR paper draft/Results/March2025_v2/DI_Water_5um_PS/deltaS_vs_frequency';
end
...
assign_iteration_32C = ones(20,1)';
% assign_set_32C = [1, 10, 20];
assign_set_32C = linspace(1,20, 20);

% assign_iteration_42C = [1,1, 1, 1, 2, 2];
assign_iteration_42C = [ones(15,1)' 2*ones(15,1)']
% assign_set_42C = [1, 5, 10, 14, 10, 15];
assign_set_42C = [linspace(1,15,15) linspace(1,15,15)]
assign_iteration_42C(11) =[];
assign_set_42C(11) = [];

assign_iteration_42C(15) =[];
assign_set_42C(15) = [];
%%
deltaS = [];
time_stamps = [];
...
exportgraphics(figure_s11m,strcat(figure_save_folder, filesep, 'reflection_all_Dr_wang_request.pdf'), 'ContentType','vector');
